...
data = {
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌', url = 'http://t.me/'..chsource..''}, 
},
}
}
...
if tonumber(Message_Edit.sender_id.user_id) == 5477138510 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender_id.user_id) == 1715562844 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender_id.user_id) == 5634805056 then
data.The_Controller = 1
...
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌', url='t.me/'..chsource..''},},
}}
...
if tonumber(IdUser) == 5477138510 then
data.The_Controller = 1
elseif tonumber(IdUser) == 1715562844 then
data.The_Controller = 1
elseif tonumber(IdUser) == 5634805056 then
data.The_Controller = 1
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌', url="t.me/RB_RO"},
},
}
}
...
keyboard.inline_keyboard = {
{
{text = '･ ⇗𝘽𝙖𝘾𝙠⇖ ･', callback_data=IdUser.."/uiserId"},
},
}
local mm = Msg_id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/EditMessagecaption?chat_id='..ChatId..'&message_id='..mm..'&caption=' .. URL.escape(txxt).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_JABWA/202",caption = '*╭───── •*[ ⍟ ](t.me/RB_RO )*• ─────╮\n├ ⍟  قم بختيار نوع الاغنيه 🎧\n╰───── •*[ ⍟ ](t.me/RB_RO )*• ─────╯\n✦ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑰𝑫𝑰  𝑩𝑬𝑻𝑻𝑬𝑹 ⏎*\n',parse_mode = "Markdown"}     
...
local Text =' ◍ قم باستعمال الازرار لرفع العضو ⇞⇟\n ◍ العضو ⇿ ['..UserInfo.first_name..'](t.me/'..(UserInfo.username or 'RB_RO')..')'
if tonumber(IdUser) == tonumber(5477138510) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id},{text="رفع مدير",data=IdUser..":SetManager:"..UserInfo.id}},{{text="رفع منشئ اساسي",data=IdUser..":SetBasicConstructor:"..UserInfo.id}},{{text="رفع مالك",data=IdUser..":SetOwner:"..UserInfo.id},{text="رفع مطور",data=IdUser..":SetSudoBot:"..UserInfo.id}},{{text="رفع مطور ثانوي",data=IdUser..":SetSecondSudo:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif tonumber(IdUser) == tonumber(5477138510) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id},{text="رفع مدير",data=IdUser..":SetManager:"..UserInfo.id}},{{text="رفع منشئ اساسي",data=IdUser..":SetBasicConstructor:"..UserInfo.id}},{{text="رفع مالك",data=IdUser..":SetOwner:"..UserInfo.id},{text="رفع مطور",data=IdUser..":SetSudoBot:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Dev:Groups"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id},{text="رفع مدير",data=IdUser..":SetManager:"..UserInfo.id}},{{text="رفع منشئ اساسي",data=IdUser..":SetBasicConstructor:"..UserInfo.id}},{{text="رفع مالك",data=IdUser..":SetOwner:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id},{text="رفع مدير",data=IdUser..":SetManager:"..UserInfo.id}},{{text="رفع منشئ اساسي",data=IdUser..":SetBasicConstructor:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."SuperCreator:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id},{text="رفع مدير",data=IdUser..":SetManager:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Creator:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Manger:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Admin:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
...
txxt = ' ◍ العضو ⇿ ['..UserInfo.first_name..'](t.me/'..(UserInfo.username or 'RB_RO')..')\n ◍ تم رفعه في قائمة المميزين'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
elseif Redis:sismember(Fast.."Devss:Groups"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text="تنزيل منشئ",data=IdUser..":RemConstructor:"..UserInfo.id},{text="تنزيل مدير",data=IdUser..":RemManager:"..UserInfo.id}},{{text="تنزيل منشئ اساسي",data=IdUser..":RemBasicConstructor:"..UserInfo.id}},{{text="تنزيل مالك",data=IdUser..":RemOwner:"..UserInfo.id},{text="تنزيل مطور",data=IdUser..":RemSudoBot:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Dev:Groups"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text="تنزيل منشئ",data=IdUser..":RemConstructor:"..UserInfo.id},{text="تنزيل مدير",data=IdUser..":RemManager:"..UserInfo.id}},{{text="تنزيل منشئ اساسي",data=IdUser..":RemBasicConstructor:"..UserInfo.id}},{{text="تنزيل مالك",data=IdUser..":RemOwner:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif StatusMember == "chatMemberStatusCreator" then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
...
elseif Redis:sismember(Fast.."Ownerss:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text="تنزيل منشئ",data=IdUser..":RemConstructor:"..UserInfo.id},{text="تنزيل مدير",data=IdUser..":RemManager:"..UserInfo.id}},{{text="تنزيل منشئ اساسي",data=IdUser..":RemBasicConstructor:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."SuperCreator:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text="تنزيل منشئ",data=IdUser..":RemConstructor:"..UserInfo.id},{text="تنزيل مدير",data=IdUser..":RemManager:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Creator:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text="تنزيل منشئ",data=IdUser..":RemConstructor:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Manger:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Admin:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Special:Group"..ChatId,IdUser) then
return bot.editMessageText(ChatId, msg_id, "* ◍ هذا الامر للادمنيه في البوت فما فوق *", 'md', true)
...
local Mostafa = (Redis:get(Fast.."Name:Bot") or "تايجر")
local txxt =[[
'\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*'
'\n🎤╖ أهلآ بك عزيزي أنا بوت '..
...
keyboard.inline_keyboard = {
{
{text = '𝘽𝙤𝙏 𝘾𝙤𝙢𝙢𝘼𝙣𝙙𝙨', callback_data=senderr.."/orders"},{text = '𝙂𝙖𝙈𝙚 𝘽𝙤𝙩', callback_data=senderr.."/games"},
},
{
{text = '𝙎𝙤𝙐𝙧𝘾𝙚 𝘽𝙤𝙏', callback_data=senderr.."/Source"},{text = '𝙄𝙣 𝙁𝙤𝙧𝙢𝙖𝙩𝙞𝙤𝙣', callback_data=senderr.."/changehhh"},
},
{
...
keyboard.inline_keyboard = {
{
{text = '𝘽𝙤𝙏 𝘾𝙤𝙢𝙢𝘼𝙣𝙙𝙨', callback_data=IdUser.."/orders"},{text = '𝙂𝙖𝙈𝙚 𝘽𝙤𝙩', callback_data=IdUser.."/games"},
},
{
{text = '𝙎𝙤𝙐𝙧𝘾𝙚 𝘽𝙤𝙏', callback_data=IdUser.."/Source"},{text = '𝙄𝙣 𝙁𝙤𝙧𝙢𝙖𝙩𝙞𝙤𝙣', callback_data=IdUser.."/changehhh"},
},
{
...
keyboard.inline_keyboard = {
{
{text = '･ ⇗𝘽𝙖𝘾𝙠⇖ ･', callback_data=IdUser.."/Arabic1"},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data=IdUser.."/BackCape"},
},
...
keyboard.inline_keyboard = {
{
{text = '･ ⇗𝘽𝙖𝘾𝙠⇖ ･', callback_data=IdUser.."/games"},
},
{
...
if tonumber(IdUser) == tonumber(UserId) then
local txxt = [[*
 • مرحبا بك في الالعاب الالكترونيه بسورس تايجر
...
local txxt = [[
╭──── • ◈ • ────╮
么 [𝙎𝙤𝙐𝙧𝘾𝙚 𝙏𝙞𝙂𝙚𝙍](t.me/RB_RO)
么 [𝘿𝙚𝙑 𝙈𝙚𝘿𝙤](t.me/JY_X6)
么 [𝘿𝙀𝙑 𝙔𝙊𝙐𝙎𝙀𝙁](t.me/Z0HARY)
么 [𝘿𝙀𝙑 𝘼𝙇𝙈𝘼𝙉𝙔](t.me/almany_basha)
么 [𝘿𝙀𝙑 𝘽𝙊𝘽](t.me/PW_BOB)
╰──── • ◈ • ────╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
data = {
{
{text = '･ ⇗𝘽𝙖𝘾𝙠⇖ ･', data = IdUser..'/secondary'}, 
},
}
}
...
data = {
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌', url = 'https://t.me/RB_RO'}, 
},
}
}
Redis:del(Fast.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/1018",caption = '*الاجابه صحيحه استمر باللعب ✅*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/1018",caption = '*مبروك عاش عليك تم إنهاء العبه بنجاح ✅*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• يلا بنا نبحث عن المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• في صوت هل صدر من الامام ام الخلف •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• هيا بنا نذهب الي الامام لنرا المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• هيا بنا نذهب الي الخلف لنرا المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• هيا •𓄹', callback_data=IdUser.."/have"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• لقد وصلنا الى المنزل شكراَ جزيلَ انتطرني ثواني وسوف اعود •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• لقد عودت إليك ظهر شيئ •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• هيا نذهب داخل المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*•  نحنو نتوه في هذه المكان •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• لا يوجد ضواء في هذا المكان •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• تعالى نذهب الي الباب الرئيسي •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• انها النهاية هتكمل ولا لا •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• سارسل اليك  سوال مع اختيارت لو حليت صح ستنجو من العقاب لو خطأ سيقوم عليك العقاب •\nالسوال هوا - شيء لا يتأثر بالماء حتى عندما يمر من خلالها فمن يكون؟*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• مبروك لقد فوزت ونجيت من العقاب •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• غلط القاب هوا خلاص سامحتك •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• غلط القاب هوا سكر خشمك و قول كلمة من اختيار  الاعبين الي معك •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• غلط القاب هوا اذهب الى واحد ماتعرفه وقل له انا كيوت وابي بوسه •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• غلط القاب هوا روح المطبخ و اكسر صحن او كوب •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• غلط القاب هوا تتصل على الوالده و تقول لها تزوجت با سر •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/RB_RO/602",caption = '*• انت ستندم سأقتلك •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
keyboard.inline_keyboard = {
{
{text = '･ ⇗𝘽𝙖𝘾𝙠⇖ ･', callback_data=IdUser.."/zDRGd"},
},
}
local mm = Msg_id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/EditMessagecaption?chat_id='..ChatId..'&message_id='..mm..'&caption=' .. URL.escape(txxt).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌', url = "http://t.me/RB_RO"}
},
{
