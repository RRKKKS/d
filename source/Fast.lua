...
chsource = Redis:get(Fast..'chsource') or "UY_X6"
chdevolper = Redis:get(Fast..'chdevolper') or "JY_X6"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5477138510,5634805056,1715562844,5471782092}
...
elseif tonumber(senderr) == 5634805056 then
...
if text == 'رفع نسخه فينوم' and msg.reply_to_message_id ~= 0 then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'*• انت لست المطور الاساسي\n√*',"md",true)  
end
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return send(msg_chat_id,msg_id,' ◍ تم استرجاع المجموعات من نسخه فينوم\n√')
else
...
---------------------- Dev JABWA ----------------------
if text == 'كيب المجموعه' or text == '/tiger' then
...
if text == (Redis:get(Fast.."Bot:Name") or "فينوم") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Bot:Name") or "فينوم")
local Mostafa = {
'• مالك حبيبى 🥺',
...
if text == (Redis:get(Fast.."Name:Bot") or "فينوم") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "فينوم")
local Mostafa = {
'• مالك حبيبى 🥺',
'• مخصماك وبعد عني مش طيقاك 😹',
'• مبكلمكش 🥺',
...
if text == "سورس" or text == "يا سورس" or text == "السورس" or text == "سورس فينوم" then
photo = "https://t.me/DEV_MEDOU/28"
local T =[[
╭──── • ◈ • ────╮
么 [𝙎𝙤𝙐𝙧𝘾𝙚 VENOM](t.me/R_N_B1)
么 [𝘿𝙚𝙑 ZOZ](t.me/ZzzzOoooozZ)
么 [𝘿𝙀𝙑 MOSCOW](t.me/U_u_63)
╰──── • ◈ • ────╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✶ اضغط لتنصيب بوتك 💗ˣ.', url = "https://t.me/med_O_Ubot"}
},
{
{text = 'أضغط لاضافه ألبوت لمجموعتك 𖣳', url = "t.me/"..UserBot.."?startgroup=new"},
},
...
if text =='قناة السورس *️⃣' or text =='قناة السورس' or text =='قناه السورس' or text =='قنات السورس' or text =='𝐒𝐎𝐔𝐑𝐂𝐄 َِ𝙏ِ𝘪َِ𝘎َِ𝘦َِ𝘳' then 
Text = [[
[🌀 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙴𝙽𝙾𝙼 𝘳](t.me/RB_RO) 


[☃️𝐃𝐄𝐕 𝐕𝐄𝐍𝐎𝐌 َِ𝘥َِ𝘦َِ𝙑َِ𝘦َِ𝙇َِ𝘰َِ𝘗َِ𝘦َِ𝘳َِ𝘴](t.me/R_N_B1)
]]


keyboard = {} 
keyboard.inline_keyboard = {{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌',url="t.me/"..chsource..""}}}
local msg_id = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg_chat_id .. '&photo=https://t.me/DEV_MEDOU/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'المصنع' or text == 'مصنع' or text == 'عايز بوت' or text == 'عايز انصب بوت' then
photo = "https://t.me/B_R_R_1/3"
local Name =[[
══════× 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌 ×══════

[⌯ 𝙒𝙚𝙇𝙘𝙈𝙚 𝙏𝙤 𝙈𝙖𝙆𝙚𝙍 𝐕𝐄𝐍𝐎𝐌 ⌯](t.me/B72_bot)

[⌯ 𝐃𝐄𝐕 𝐕𝐄𝐍𝐎𝐌 ⌯](t.me/RB_RO)

[⌯ 𝙏𝙬𝘼𝙨𝙇 𝐕𝐄𝐍𝐎𝐌 ⌯](t.me/R_N_B1)
...
keyboard.inline_keyboard = {
{
{text = '𝙈𝘼𝙆𝙀𝙍', url = 't.me/B72_bot?start'},
},
{
...
local t = "*اليك قائمة الافلام من سورس فينوم ◍ *"
local m = "https://t.me/UY_X6/1188"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == '〘 مبرمج السورس 〙' or text == 'مبرمج السورس' or text == 'medo' or text == 'محمد' or text == 'ميدو' then  
...
if photo.total_count > 0 then
local DevJabwa = "*√︙ 𝑑𝑒𝑣 𝑠𝑜𝑢𝑟𝑐𝑒   ♯*\n*√︙ɴᴀᴍᴇ -› *"..ban.first_name.."\n*√︙ 𝒊𝒅 -› "..UserId_Info.id.."*\n*√ᴜѕᴇ* [@"..ban.username.."]\n*︙ 𝒃??𝒐 -›*  *"..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '𝑫𝒆𝒗 𝑴𝒆𝒅𝒐', url = "https://t.me/UY_X6"}
},
}
local msg_id = msg.id/2097152/0.5 
...
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/UY_X6"}
},
}
local msg_id = msg.id/2097152/0.5 
...
if text == 'كوكو' or text == 'لوكا' or text == 'loka' or text == 'قلب ميدو' or text == 'لقاء' then  
local UserId_Info = bot.searchPublicChat("Loka7a")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local DevJabwa = "*√︙𝒑𝒓𝒊𝒏𝒔𝒔𝒆 𝒍𝒐𝒌𝒂✨   ♯*\n*√︙ɴᴀᴍᴇ -› *"..ban.first_name.."\n*√︙ 𝒊𝒅 -› "..UserId_Info.id.."*\n*√︙ 𝒃𝒊𝒐 -›*  *"..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '𝒑𝒓𝒊𝒏𝒔𝒔𝒆 𝒍𝒐𝒌𝒂✨ ', url = "https://t.me/Loka7a"}
},
}
local msg_id = msg.id/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(DevJabwa)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
else
local DevJabwa = "*√︙𝒑𝒓𝒊??𝒔𝒔𝒆 𝒍𝒐𝒌𝒂✨   ♯*\n*√︙𝒏𝒂𝒎𝒆  -› *"..ban.first_name.."\n*√︙ 𝒊𝒅  -› "..UserId_Info.id.."*\n*√︙ 𝒃𝒊𝒐 -›*  *"..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/Loka7a"}
},
}
local msg_id = msg.id/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(DevJabwa).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'يوصف' or text == 'زوهري' or text == 'مطور السورس 🔱' then
local UserId_Info = bot.searchPublicChat("Z0HARY")
if UserId_Info.id then
...
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/Z0HARY"}
},
{
{text = '• سـوࢪس تـ ـايـجر🍇 •', url = "https://t.me/UY_X6"},
},
}
local msg_id = msg.id/2097152/0.5 
...
if text == 'بوب' or text == 'مطور بوب' or text == 'المبرمج السورس √' then
...
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/PW_BOB"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'الماني' or text == 'المبرمج الماني' or text == 'بنت ميدو' then
local UserId_Info = bot.searchPublicChat("almany_basha")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/almany_basha"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
data = {
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 َِ𝙏ِ𝘪َِ𝘎َِ𝘦َِ𝘳', url = "https://t.me/UY_X6"}
},
}
}
...
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "فينوم")
if text then
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = ' '..UserInfo.first_name..' ', url = 't.me/'..UserInfo.username}, },{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 َِ𝙏ِ𝘪َِ𝘎َِ𝘦َِ𝘳', url = 't.me/UY_X6'},},}}
...
{{text='𝐒𝐎𝐔𝐑𝐂𝐄 َِ𝙏ِ𝘪َِ𝘎َِ𝘦َِ𝘳',url='t.me/'..chsource..''}}, 
}
}
...
local CmdStart = '*\n.. ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ'.. 
'\n🎤╖ أهلآ بك عزيزي أنا بوت '..(Redis:get(Fast.."Name:Bot") or "تايجر")..
